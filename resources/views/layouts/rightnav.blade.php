    ...
    <div id="slide-out-right" class="slide-out-right-sidenav sidenav rightside-navigation">
      <div class="row">
              ...
              <div class="col s10 pl-0">
                <ul class="tabs">
                  <li class="tab col s6 p-0">
                    <a href="#reservation" class="active">
        ...
        <div class="slide-out-right-body row pl-3">
          <div id="reservation" class="col s12 pb-0">
            <form class="row">
                <div class="col s12">
                    <div class="input-field col s12">
                        <select id="zoneSelect" class="materialSelect">
                          <option value="" disabled selected>Choose your option</option>
                          <option value="red">Zone Red</option>
                          <option value="blue">Zone Blue</option>
                ...
                <div class="col s12">
                  <div class="input-field col s12">
                    <input type="text" id="deskInput">
                    <label for="deskInput">Desk/Room</label>
                  </div>
                </div>
                <div class="col s12">
                  <div class="input-field col s12">
                ...
                <div class="col s12">
                  <div class="input-field col s12">
                    <input type="number" id="durationInput" value="1" min='1' max="24">
                    <label for="durationInput">Duration</label>
                    <div class="suffix">Hours</div>
                  </div>
                </div>
                <div class="col s12">
                  <button class="btn waves-effect pull-right">Make Reservation</button>
                </div>
              </form>
          </div>
