...
@section('page')
    <div class="col s12 m12 l12">
        <div class="card" style="border-radius: 10px;">
            <div class="card-content gradient-45deg-purple-deep-purple" style="border-top-left-radius: 10px; border-top-right-radius:10px;">
                <span class="card-title white-text"> TECH Hot Desks</span>
                <a id="map-trigger" class="btn-floating waves-effect waves-light gradient-45deg-light-blue-cyan tooltipped hoverable z-depth-2 " data-position="bottom" data-tooltip="View Red Zone Map" style="float:right" href="#"> 
            ...
            <div class="card-content">
                <div class="card-title">
                    <div class="input-field col s7 l6">
                        <input type="text" class="datepicker" value="{{ \Carbon\Carbon::now()->format("Y M d") }}" id="pat">
                        <label for="pat">Pick A Date</label>
                    </div>
